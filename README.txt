...
o controlador de usuário recebe os dados enviando-os para a classe de serviço onde temos as validações,
se tudo estiver certo acontece a inserção no banco de dados h2, o controlador de usuário pode criar,
